        ...
        <div className="rounded-xl grid grid-cols-2">
            ...
            <div className="bg-yello-700 relative">
                <div className="w-40 h-40 left-[-25px] top-7 bg-black absolute flex justify-center items-center">
                    ...
                    <img className="bg-white w-16 h-16 -rotate-45 rounded-full" src="https://s3-alpha-sig.figma.com/img/05b4/764d/7410b2b85fbc35b68e97884a21b2dcdf?Expires=1729468800&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=moIF0Y6lGKHWL6WRU6gECVuJB4kWup7VHBkzjOrhYX66oAD70IGmMBCRs~mK94UPN3PLbnEcgGxODFdt8Hnl4rHKpfme2knKZs4v2F89Mqv-iCQ8rxdOYhuoGaUjfaBLVLg~CPgEEcLZv0N3g-CyWFvNI2v6okUAymzSp0ruXo-76~hMUqcQFIOG2rrauLmG3a49yHoJ0uyy-EOPQE5XXLkIIPFG0xALN0kL9GkgLeFBLuC7-MAgKPRzO31K69vEKut0V-7zX5T~TGvEDqlvKiOK7Uah-98PXxragw5LMivbIevYijswTC-8yDeIl851VnWLUYQetLaLrZHLaiLIeg__"></img>
                </div>
